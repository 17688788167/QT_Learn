...
void MyOpenglWidget::initializeGL()
{
    ...
    Actor* actor1=new Actor(1,0,0,":/shaders/shapes.vs",":/shaders/shapes.fs");
    ActorVector.push_back(actor1);

    Actor* actor2=new Actor(1,0.5f,0.5f,":/shaders/shapes.vs",":/shaders/shapes1.fs");
    ActorVector.push_back(actor2);
     ...
     for (int i=0;i<ActorNum;++i)
     {
         ...
         glBufferData(GL_ARRAY_BUFFER, sizeof(Data::verticesAndTexCoords),ActorVector[i]->ModelVertices, GL_STATIC_DRAW);
