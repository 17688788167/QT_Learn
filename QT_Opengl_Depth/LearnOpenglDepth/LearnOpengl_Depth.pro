...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../environment/lib/ -lassimp-vc142-mt
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../environment/lib/ -lassimp-vc142-mtd
else:unix: LIBS += -L$$PWD/../../environment/lib/ -lassimp-vc142-mt

INCLUDEPATH += $$PWD/../../environment/include
DEPENDPATH += $$PWD/../../environment/include
