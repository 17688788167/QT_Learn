...
public:
 ...
 constexpr static float planeVertices[] = {
      ...
      10.0f, 0, 10.0f, 0.0f, 1.0f, 0.0f, 10.0f, 0.0f,
      -10.0f, 0, -10.0f, 0.0f, 1.0f, 0.0f, 0.0f, 10.0f,
      -10.0f, 0, 10.0f, 0.0f, 1.0f, 0.0f, 0.0f, 0.0f,

      10.0f, 0, 10.0f, 0.0f, 1.0f, 0.0f, 10.0f, 0.0f,
     10.0f, 0, -10.0f, 0.0f, 1.0f, 0.0f, 10.0f, 10.0f,
      -10.0f, 0, -10.0f, 0.0f, 1.0f, 0.0f, 0.0f, 10.0f
