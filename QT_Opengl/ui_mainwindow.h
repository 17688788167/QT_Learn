...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("C:/Users/admin/Desktop/data.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        openGLWidget = new XXOpenGlWidget(centralWidget);
        openGLWidget->setObjectName(QStringLiteral("openGLWidget"));
        openGLWidget->setGeometry(QRect(190, 60, 681, 461));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "\350\276\276\351\227\274", Q_NULLPTR));
